...
describe 'roman_numerals' do
  ...
  #     expect(convert_to_rn(1)).to eq "I"
  #   end
  #
  ...
  context 'Subtract' do
    ...
    it 'can subtract one number from another' do
      expect(subtract(10, 1)).to eq 9
    end

  end

  context 'Add divisors to array' do

    it 'adds divisors to array' do
      add_divisors_to_array(50)
      expect(divisors).to include(50)
    end
